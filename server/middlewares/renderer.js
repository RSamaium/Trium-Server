...
module.exports = function(app) {
  ...
  if (isProd) {
    ...
    renderer = createRenderer(fs.readFileSync(resolve('../../client/dist/server-bundle.js'), 'utf-8'))
    indexHTML = parseIndex(fs.readFileSync(resolve('../../client/dist/index.html'), 'utf-8'))
  } else {
  ...
  if (isProd) {
    app.use('/dist', serve('../../client/dist'));
  }
  else {
